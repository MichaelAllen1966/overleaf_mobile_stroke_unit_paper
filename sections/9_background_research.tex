...
\subsubsection{Saarland, Germany, 2019, Helwig \cite{helwig_prehospital_2019}}
...
Further results are given in figure \ref{fig:helwig_2019}.

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{images_background/helwig_2019.png}
...
\subsection{Cleveland, Taqui, 2017 \cite{taqui_reduction_2017}}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{images_background/taqi_2017.png}
    \caption{Results fot Taqi et al \cite{taqui_reduction_2017}}
    \label{fig:taqi_2017}
\end{figure}

\subsubsection{New York, Kummer, 2019, \cite{kummer_geographic_2019}}
